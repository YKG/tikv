...
pub struct Config {
    ...
    pub grpc_batch_threshold_cpu_load: usize,
    pub grpc_batch_threshold_mss: usize,
    pub grpc_batch_threshold_msg_count: usize,
    pub grpc_batch_timeout: u64,
...
impl Default for Config {
    fn default() -> Config {
        ...
        Config {
            ...
            grpc_batch_threshold_cpu_load: 25,
            grpc_batch_threshold_mss: 1400,
            grpc_batch_threshold_msg_count: 8,
            grpc_batch_timeout: 30,
